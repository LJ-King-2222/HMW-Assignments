...
#BABA Information
BABA = pd.read_csv('C:\\Users\\LJone\\Fin510\\Stocks_gf\\BABA.csv')
BABA.head()
BABA ["Date"] = pd.to_datetime(BABA["Date"])

#SOFI Information
SOFI = pd.read_csv('C:\\Users\\LJone\\Fin510\\Stocks_gf\\SOFI.csv')
SOFI.head()
SOFI ["Date"] = pd.to_datetime(SOFI["Date"])

#SPY Information
SPY = pd.read_csv('C:\\Users\\LJone\\Fin510\\Stocks_gf\\SPY.csv')
SPY.head()
